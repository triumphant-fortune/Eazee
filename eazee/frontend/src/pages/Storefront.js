...
export default function Storefront() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="py-8 px-4" style={{ backgroundColor: palette.bg }}>
        <div className="max-w-lg mx-auto text-center">
          {vendor.logo_url ? (
            ...
            <div
              className="w-20 h-20 rounded-2xl mx-auto mb-3 flex items-center justify-center text-white text-3xl font-bold shadow-sm"
          ...
          {vendor.bio && (
            <p className="mt-2 text-sm text-gray-500 max-w-xs mx-auto leading-relaxed">{vendor.bio}</p>
          )}
            ...
            <div className="grid grid-cols-2 gap-3">
              {products.map(product => (
                <button
                  ...
                  className="bg-white rounded-2xl overflow-hidden border border-gray-100 text-left hover:shadow-md transition-shadow active:scale-95 transition-transform"
                >
                  <div className="aspect-square bg-gray-100 overflow-hidden">
                    {product.media_url ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center" style={{ backgroundColor: palette.light }}>
                  ...
                  <div className="p-3">
                    ...
                    <p className="font-bold text-sm mt-1" style={{ color: palette.primary }}>
      ...
      {selectedProduct && (
        <div
          className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-end justify-center p-0"
        ...
        >
          ...
          >
            ...
            <p className="text-2xl font-bold mt-1" style={{ color: palette.primary }}>
            ...
            <button
              onClick={() => setSelectedProduct(null)}
              className="mt-3 w-full py-3 rounded-2xl text-gray-500 text-sm font-medium border border-gray-100 hover:bg-gray-50 transition"
            >
              Close
            </button>
          </div>
